...
public class MaterialDialog {
    ...
    private final static int BUTTON_LEFT = 9;
    ...
    public MaterialDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        ...
        mPositiveButton.setBackgroundResource(R.drawable.selector_btn_material);
        ...
        layoutParams.setMargins(dip2px(BUTTON_LEFT), dip2px(BUTTON_TOP), dip2px(BUTTON_LEFT), dip2px(BUTTON_BOTTOM));
    ...
    public MaterialDialog setNegativeButton(int resId, final View.OnClickListener listener) {
        ...
        mNegativeButton.setBackgroundResource(R.drawable.selector_btn_material);
        mNegativeButton.setText(resId);
        mNegativeButton.setTextColor(Color.argb(255, 35, 159, 242));
...
//7
            ...
            if (mLayoutParams != null && mNegativeButton != null) {
                if (mButtonLayout.getChildCount() > 0) {
                    mLayoutParams.setMargins(dip2px(BUTTON_LEFT), dip2px(BUTTON_TOP), 0, dip2px(BUTTON_BOTTOM));
                    mNegativeButton.setLayoutParams(mLayoutParams);
...
//            button.setBackgroundResource(R.drawable.material_card);
            ...
            button.setPadding(dip2px(BUTTON_LEFT), 0, dip2px(BUTTON_LEFT), dip2px(BUTTON_BOTTOM));
